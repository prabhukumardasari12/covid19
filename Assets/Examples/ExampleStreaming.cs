...
public class ExampleStreaming : MonoBehaviour
    {
        ...
        public GameObject level1Manger;
        ...
        private void OnRecognize(SpeechRecognitionEvent result)
        {
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    ...
                    if (alt.transcript.Contains("open"))
                        {
                        level1Manger.GetComponent<Level1Manger>().OpentheDoor();
                       // ResultsField.text = "Working Fine";
                        }
                        if (alt.transcript.Contains("close"))
                        {
                        level1Manger.GetComponent<Level1Manger>().CloseDoor();
                        }
                    }
